...
Align a set of RNA-seq reads to the _Mycobacterium smegmatis_ MC2 155 genome assembly and perform a basic analysis.
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_HomeScreen.tiff)
...
![This is the proper place to click to fetch the FASTA file](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/BactEnsembl_FASTA.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_GetData.tiff)

<br>
Next, click __Upload File from your computer__
  
   
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_UploadFileFromYourComputer.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_UploadScreen.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/ENA_Search.tiff)

<br>
On the results page, select the first link (`SRP017906`) to look at the study. 

![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/ENA_Results.tiff)

***

### Import into Galaxy

On the results page, make note of the `SSR-` values in the _Run accession_ column. Each of these files is an individual run through the sequencing machine. Copy the first string you see (`SSR647673`). 

![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/ENA_ResultsList.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_NCBITools.tiff)

<br>
On this page, paste your copied run accession code (`SSR647673`) into the appropriate blank field. Then click execute. 

![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_ExtractReads.tiff)

<br>
This will add the file (as a pending job) to your history on the right. Not that this process can take quite a bit of time to complete. Repeat the above for the other three `SSR-` files (`SSR647674`,`SSR647675`). Note that these files will be in the `fastqsanger` format.
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_FindFastQC.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_RunFastQC.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/FastQC.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_FindBowtie.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_UseBowtie.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_FindHTSeq.tiff)
...
![](/Users/kshank/Desktop/Giles_RNA_Seq_Analysis/Galaxy_RunHTSeq.tiff)
